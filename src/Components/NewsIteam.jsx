...
const NewsIteam = (props) => {
  return (
       <div className="container-sm bg-dark text-light d-inline-block m-5 px-2 py-2 " style={{ maxWidth: "345px", maxheight:"500px"}}>
         <div><img src={props.src?props.src:image} style={{height:"200px" ,width:"325px"}} className="img-top" /><br></br></div>
         <div className="">
